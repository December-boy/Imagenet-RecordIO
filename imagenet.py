...
_TARGET_DIR = '/home/zqq/datasets/ImageNet/'
...
def parse_args():
    ...
    parser.add_argument('--download-dir', default='/home/zqq/datasets/ImageNet/',
                        help="The directory that contains downloaded tar files")
    parser.add_argument('--target-dir', default='/home/zqq/datasets/ImageNet',
...
def extract_val(tar_fname, target_dir, with_rec=False, num_thread=1):
    ...
    val_maps_file = os.path.join('/home/zqq/datasets/ImageNet', 'imagenet_val_maps.pklz')
...
def main():
    ...
    if build_rec and not os.path.exists(os.path.join(target_dir, 'rec')):
